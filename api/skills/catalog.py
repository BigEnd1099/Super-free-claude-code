...
class SkillCatalog:
    ...
    def __init__(self):
        self.bundles = {
            "Security Engineer": ["security-auditor", "security-review", "security-scan"],
            "Full-Stack Developer": ["test-driven-development", "debugging-strategies", "code-review"],
            "Architect": ["api-design-principles", "hexagonal-architecture", "architecture-decision-records"]
        }
    ...
    def get_skills_by_category(self, category: str) -> list[dict[str, Any]]:
        return [s for s in self.get_all_skills() if s["category"].lower() == category.lower()]
