...
class NeuralMapAccessSkill(Skill):
    ...
    input_schema = {
        ...
        "properties": {
            "query_type": {
                ...
                "description": "Type of query: 'full_graph' for everything, 'find_node' to find a specific file/class, 'neighborhood' for immediate neighbors of a node."
            },
            "target_id": {
                "type": "string",
    ...
    async def run(self, query_type: str, target_id: str = None) -> Dict[str, Any]:
            ...
            async with httpx.AsyncClient(timeout=30.0) as client:
                ...
                if query_type == "full_graph":
                    ...
                    return {
                        ...
                        "nodes_sample": data.get("nodes", [])[:50], # Sample to avoid overloading
                    ...
                    found = [n for n in data.get("nodes", []) if target_id.lower() in n.get("id", "").lower() or target_id.lower() in n.get("label", "").lower()]
                    ...
                    connected_edges = [e for e in edges if e["from"] == target_id or e["to"] == target_id]
                    neighbor_ids = set()
